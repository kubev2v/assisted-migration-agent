...
type inspectionBuilderFactory = func(id string) work.WorkBuilder[models.InspectionStatus, models.InspectionResult]

func defaultInspectionBuilderFactory(store *store.Store, operator vmware.VMOperator, detector *vmdetect.Detector) inspectionBuilderFactory {
	return func(vmID string) work.WorkBuilder[models.InspectionStatus, models.InspectionResult] {
