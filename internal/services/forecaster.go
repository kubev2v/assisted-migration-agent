...
type ForecasterService struct {
	mu        sync.Mutex
	pool      *store.Pool
	workPool  *work.Pool[models.ForecastPairStatus, models.ForecastResult]
...
func collectPairStatuses(
	wp *work.Pool[models.ForecastPairStatus, models.ForecastResult],
	pairNames []string,
...
func (f *ForecasterService) Start(ctx context.Context, req models.ForecastRequest) (err error) {
	...
	builders := make(map[string]work.WorkBuilder[models.ForecastPairStatus, models.ForecastResult], len(req.Pairs))
...
func (f *ForecasterService) mainStore() (*store.Store, error) {
...
func (f *ForecasterService) latestCollectionStore() (*store.Store, error) {
