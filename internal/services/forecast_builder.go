...
type forecastBuilder struct {
	...
	store       *store.Store
	strategy    forecaster.BenchmarkStrategy
...
func (b *forecastBuilder) New() work.WorkBuilder2[models.ForecastPairStatus, models.ForecastResult] {
	b.units = []work.WorkUnit[models.ForecastPairStatus, models.ForecastResult]{
		{
	...
	for iter := range b.iterations {
		i := iter + 1
		b.units = append(b.units, work.WorkUnit[models.ForecastPairStatus, models.ForecastResult]{
			Status: func() models.ForecastPairStatus {
