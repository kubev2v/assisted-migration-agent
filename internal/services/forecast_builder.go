...
type forecastBuilderFactory = func(pair models.DatastorePair) work.WorkBuilder[models.ForecastPairStatus, models.ForecastResult]

func defaultForecastBuilderFactory(dm *vmware.DiskManager, st *store.Store, strategyFn func() BenchmarkStrategy, diskSizeGB, iterations int, sessionID int64) forecastBuilderFactory {
	return func(pair models.DatastorePair) work.WorkBuilder[models.ForecastPairStatus, models.ForecastResult] {
		b := &forecastBuilder{
			diskManager: dm,
			store:       st,
			strategy:    strategyFn(),
...
func (b *forecastBuilder) build() *work.SliceWorkBuilder[models.ForecastPairStatus, models.ForecastResult] {
	...
	return work.NewSliceWorkBuilder(units, finalize)
}
