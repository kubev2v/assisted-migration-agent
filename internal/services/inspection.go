...
type inspectionPipeline = work.Pipeline[models.InspectionStatus, models.InspectionResult]
type inspectionWorkBuilder = func(id string) []InspectionWorkUnit

// InspectionWorkUnit is a single step in an inspection pipeline.
...
func (i *inspectionService) Start(vmIDs []string, cleanupFn func()) error {
	...
	for _, id := range vmIDs {
		...
		pipeline := work.NewPipeline(models.InspectionStatus{State: models.InspectionStatePending}, i.scheduler, work.NewSliceWorkBuilder(units))
...
func (i *inspectionService) wrapWorkUnits(id string, units []InspectionWorkUnit) []work.WorkUnit[models.InspectionStatus, models.InspectionResult] {
	wrapped := make([]work.WorkUnit[models.InspectionStatus, models.InspectionResult], len(units))
	for idx, u := range units {
		u := u
		wrapped[idx] = work.WorkUnit[models.InspectionStatus, models.InspectionResult]{
