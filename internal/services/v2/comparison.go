...
// Each collection is queried independently via its own Store2 connection.
...
func NewComparisonService(storeA, storeB *store.Store2, metaA, metaB models.CollectionMeta) *ComparisonService {
