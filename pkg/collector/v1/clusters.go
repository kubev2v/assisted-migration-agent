...
// ClusterIDMapping contains cluster-related mappings extracted from vSphere data.
...
func ExtractVSphereClusterIDMapping(
...
) (ClusterIDMapping, map[string]string, map[string][]vspheremodel.VM) {
	...
	clusterMapping := ClusterIDMapping{
